                ...
                <div className="mt-7 space-y-3">
                    <button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2
                                   bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-2xl
                                   font-semibold tracking-wide transition-all shadow-md shadow-blue-500/20"
                    >
                    ...
                    <button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2
                                   ...
                                   py-3 rounded-2xl font-semibold tracking-wide transition-all"
                    >
